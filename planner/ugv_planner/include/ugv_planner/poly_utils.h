...
#include <ugv_planner/PolyhedronMSG.h>
#include <ugv_planner/PolyhedronArrayMSG.h>
//#include <polyhedron_generator/cluster_server.cuh>
#include <ugv_planner/cluster_server_cpu.h>

#include "glpk.h"
#include "data_type.h"
#include "ugv_planner/Polyhedron.h"
...
private:
    ...
    pair<ugv_planner::PolyhedronMSG, decomp_cvx_space::Polytope> polyHrep2Utils(const pair<MatrixXd, VectorXd> & hrep, const MatrixXd & cur_vertices, bool is_degenarate);
...
public:
    ...
    int corridorIncreGeneration (const vector<Vector3d> & coordSet, ugv_planner::PolyhedronArrayMSG & poly_array_msg);
    int corridorInsertGeneration(const vector<Vector3d> & coordSet, ugv_planner::PolyhedronArrayMSG & poly_array_msg);
    
    void corridorGeneration(const vector<Vector3d> & gridPath, ugv_planner::PolyhedronArrayMSG & poly_array_msg);
